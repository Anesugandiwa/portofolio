    ...
    <section class="bg-secondary relative pt-[140px] pb-[125px]">
        ...
        <div class="container">
            <div class="grid grid-cols-1 2xl:-mx-4">
                <div class="xl:pt-12">
                        <span
                            class="font-Syne text-white font-bold text-2xl lg:text-[32px] leading-none flex flex-wrap items-center mb-3"
          ...
          <span class="mr-6">
            <svg xmlns="http://www.w3.org/2000/svg" width="65" height="2" viewBox="0 0 65 2" fill="none">
              <path d="M0 1H65" stroke="#080808" />
                        ...
                        Hello, I’m
                        <img class="ml-2" src="{{asset('assets/images/victory.png')}}" alt="icon">
                        </span>
                    <h1 class="relative z-[1] font-Syne text-white font-bold text-[80px] lg:text-[100px] xl:text-[120px] 2xl:text-[140px] leading-[64px] lg:leading-[80px] xl:leading-[90px] 2xl:leading-[110px] 2xl:before:w-[120px] xl:before:w-[100px] 2xl:before:h-[120px] xl:before:h-[100px] before:rounded-full before:bg-primary before:block before:absolute before:top-[0px] before:left-0 before:-z-[1] lg:before:w-[85px] lg:before:h-[85px] before:w-[70px] before:h-[70px]" data-aos="fade-right" data-aos-delay="400">
                        Anesu
                        <!-- <br /> Anesu -->
                    </h1>
                    <h2 class="font-Syne text-white font-bold text-[80px] lg:text-[100px] l:text-[120px] 2xl:text-[140px] leading-[64px] lg:leading-[80px] xl:leading-[90px] 2xl:leading-[110px] mb-[20px]" data-aos="fade-right" data-aos-delay="600">
                        Gandiwa</h2>
                    <p class="font-Syne text-white-700 font-bold text-lg md:text-xl xl:text-2xl leading-tight mb-[30px]" data-aos="fade-right" data-aos-delay="800">
                        Web Designer|
                        Based in
                        Harare, Zimbabwe</p>
                ...
                <div class="col-span-12 xl:col-span-8">
                    <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
                        ...
                        <div class="px-6 py-7 bg-black-500 rounded-lg transition-all hover:shadow-2xl hover:bg-white group" data-aos="fade-up" data-aos-delay="500">
                            ...
                            <!-- Icon End -->
                            <h4>
                                <a href="" class="flex flex-wrap items-end justify-between font-bold text-xl font-Syne text-black-800 group-hover:text-orange transition-all">
                ...
                <div class="col-span-12 xl:col-span-4" data-aos="zoom-in" data-aos-delay="1000">
                    <div class="px-6 py-9 bg-black-800 rounded-lg flex flex-wrap flex-col justify-between max-w-[416px] mx-auto h-full group">
                        ...
                        <div class="flex flex-col flex-wrap gap-y-2">
                            ...
                            <h4 class="text-white text-xl xl:text-[22px] font-bold font-Syne leading-none">anesugandiwa9@gmail.com
                            </h4>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-[60px] xl:gap-[134px]">
                ...
                <div class="font-bold font-Syne leading-none flex flex-wrap flex-col gap-y-2">
                    ...
                    <h3 class="text-orange text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px] relative before:rounded-full before:bg-primary before:block before:absolute before:top-[2px] before:left-0 before:-z-[1] before:w-[36px] lg:before:w-[48px] xl:before:w-[64px] before:h-[36px] lg:before:h-[48px] xl:before:h-[64px]">
                        Anesu Gandiwa, Software Engineer
                    </h3>

                    <h4 class="text-orange text-2xl lg:text-3xl xl:text-[44px] mt-3 mb-4">Based in Zimbabwe</h4>
                    <p class="paragraph mb-6">I have deep enthusiasim for creating innovative software and
                        hardware solution that empower individuals to focus on
                        more challenging and rewarding endevours while technology takes care of the rest. .</p>
                    <ul class="flex flex-wrap gap-9 2xl:gap-[40px] mb-7">
                        <li>

                                <span
                                    class="text-white text-[32px] font-bold font-Syne leading-10 relative before:rounded-full before:bg-black-300 before:block before:absolute before:top-[0px] before:left-0 before:right-0 before:-z-[1] before:w-[43px] before:h-[43px]">10</span>
                            <p class="paragraph">Job done successfully</p>
                        </li>
                    </ul>

                    <div class="flex flex-wrap">
                        <a href="" class="flex items-center flex-wrap btn-primary group">Download my resume
                            <span class="inline-block ml-3 group-hover:animate-arrow-move-up">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 17L17 7" stroke="currentColor" stroke-opacity="0.9" stroke-width="2"
            ...
            <div class="grid grid-cols-12 lg:gap-[60px] xl:gap-[100px] 2xl:gap-[134px]">
                ...
                <div class="col-span-12 lg:col-span-5 2xl:col-span-4" data-aos="fade-up">
                    ...
                    <div class="font-bold font-Syne leading-none flex flex-wrap flex-col gap-y-2 mb-4">
                        ...
                        <h3 class="text-white text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px] relative before:rounded-full before:bg-primary before:block before:absolute before:top-[2px] before:left-0 before:-z-[1] before:w-[36px] lg:before:w-[48px] xl:before:w-[64px] before:h-[36px] lg:before:h-[48px] xl:before:h-[64px]">
                ...
                <div class="col-span-12 lg:col-span-7 2xl:col-span-8" data-aos="fade-up" data-aos-delay="400">
                    <div id="about_me_tab" class="tab-content active relative">
                        <div class="grid grid-cols-1">
                            <h4 class="text-orange text-2xl lg:text-[32px] font-bold font-Syne mb-6">Based in Harare, Zimbabwe</h4>
                            <p class="paragraph mb-7">Anesu Gandiwa, <span class="text-white">Software developer</span>,
                                based
                                in
                                Zimbabwe. I am an individual who have a passion<br>
                                in the field of computer science.
                                My strengths are mainly in programming specifically web<br>
                                development,
                                mobile app development. l have 1 year of coding experience. </p>

                            <ul class="flex-col gap-3 inline-flex">
                                <li class="gap-10 inline-flex items-center">
                                        <span class="w-[110px] text-orange text-lg font-normal leading-none">
                                    Name</span>
                                    <span class="text-white text-2xl font-bold font-Syne leading-8">
                                    Anesu Gandiwa</span>
                                </li>
                                <li class="gap-10 inline-flex items-center">
                                        <span class="w-[110px] text-orange text-lg font-normal leading-none">
                                ...
                                <li class="gap-10 inline-flex items-center">
                                    ...
                                    Phone</span>
                                    <span class="text-white text-2xl font-bold font-Syne leading-8">
                                    +263 712 895 388 | +263 786 310 810</span>
                                </li>
                                <li class="gap-10 inline-flex items-center">
                                        <span class="w-[110px] text-orange text-lg font-normal leading-none">
                                    Email</span>
                                ...
                                <li class="gap-10 inline-flex items-center">
                                        <span class="w-[110px] text-orange text-lg font-normal leading-none">
                                    Experience</span>
                                    <span class="text-white-800 text-2xl font-bold font-Syne leading-8">
                                    1 year</span>
                                </li>
                                <li class="gap-10 inline-flex items-center">
                                        <span class="w-[110px] text-orange text-lg font-normal leading-none">
            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12" data-aos="fade-up">
                    <div class="font-bold font-Syne text-center leading-none flex flex-wrap flex-col gap-y-2 mb-10">
                        <h2>
                            <span class="text-orange text-xl align-content-center" >Portfolio</span>
                        </h2>
                ...
                <div class="col-span-12 md:col-span-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="rounded-[20px] overflow-hidden mb-6">
                        <img src="{{asset('assets/images/img3.jpg')}}" id="logo" alt="project1">
                    </div>
                ...
                <div class="col-span-12 md:col-span-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="rounded-[20px] overflow-hidden mb-6">
                        <img src="{{asset('assets/images/logo.png')}}" id="logo" alt="project1">
                    </div>
                    <div class="flex flex-wrap flex-col gap-3">
                        <div class="flex flex-wrap gap-2">
                            <a class="text-xs text-black-text-800 uppercase font-medium font-Inter leading-none py-[6px] px-4 rounded-[40px] border border-black-text-400 transition-all hover:bg-active hover:border-active hover:text-white" href="projects.html">APP</a>
